...
export function generateIncidents(count = 1250, seed = 20260427): AsrsIncident[] {
  ...
  for (let index = 0; index < count; index += 1) {
    ...
    const partial: Omit<AsrsIncident, "narrative" | "extracted_keywords"> = {
      ...
      locationStatus: "airport_name_match",
      operatingEnvironment: airport.type === "towered" ? "Tower / ATC-involved" : airport.type === "uncontrolled" ? "UNICOM / Uncontrolled" : "CTAF / Non-towered",
